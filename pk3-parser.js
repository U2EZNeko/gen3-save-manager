...
class PK3Parser {
  ...
  static parse(buffer, filename = null) {
    ...
    // Helper function to safely read from buffer
    ...
    const data = {
      ...
      // TID at 0x04-0x05, SID at 0x06-0x07
      // TID and SID are in header: TID at 0x04-0x05, SID at 0x06-0x07
      ...
      ivs: this.extractIVs(buffer, dataOffset + 0x28), // Block D + 0x04 = 0x48
      ability: this.extractAbility(buffer, dataOffset + 0x28), // Block D + 0x04 = 0x48
      ...
      // In PKHeX exports: The header (0x00-0x1F) IS the PK3 Data structure!
      // So OT Name is at 0x14-0x1A in the header (7 bytes)
      // PKHeX uses StringConverter3.GetString() which uses the G3_EN lookup table
      // Language is at 0x12 in the header
  ...
  static getOriginGameName(gameCode) {
    ...
    const games = {
      ...
      8: 'XD',
      15: 'Channel',
      // PKHeX extended codes (based on actual file analysis)
      17: 'Ruby',
      18: 'Sapphire',
      25: 'FireRed',
      26: 'LeafGreen',
      ...
      73: 'XD',
      74: 'Channel',
      89: 'Channel', // Alternative code for Channel
      97: 'Unknown',
      98: 'Unknown',
    };
  ...
  static getMetLocationName(locationCode, gameCode) {
    ...
    const rseLocations = {
      ...
      50: 'Route 134', 51: 'Underwater', 52: 'Granite Cave', 53: 'Mt. Chimney', 54: 'Safari Zone',
      55: 'Battle Tower', 56: 'Petalburg Woods', 57: 'Rusturf Tunnel', 58: 'Abandoned Ship', 59: 'New Mauville',
    ...
    const frlgLocations = {
      ...
      126: 'Underground Path', 127: 'Diglett\'s Cave', 128: 'Victory Road', 129: 'Rocket Hideout', 130: 'Rocket Hideout',
      131: 'Rocket Hideout', 132: 'Rocket Hideout', 133: 'Rocket Hideout', 134: 'Silph Co.', 135: 'Pokémon Mansion',
      136: 'Safari Zone', 137: 'Pokémon Tower', 138: 'Seafoam Islands', 139: 'Pokémon League', 140: 'Rock Tunnel',
      141: 'Seafoam Islands', 142: 'Pokémon Tower', 143: 'Power Plant', 144: 'Victory Road', 145: 'Cerulean Cave',
